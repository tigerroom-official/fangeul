...
### 3.1 수익 구조 (패널 토론 2026-02-28 확정)

> 상세 토론 기록: `docs/discussions/2026-02-28-bubble-monetization.md`

**Free:**
- 전체 핵심 기능 (키패드, 변환, 발음, **플로팅 버블 기본 기능 포함**)
- 기본 문구팩 (30~50개)
- 조건부 배너 광고 (보상형 1회 시청 시 세션 제거, DAU 15% 전환 달성 시 전면 종료)

**보상형 광고 해금 ("팬 패스"):**
- 광고 1회 시청 → **4시간 해금** ("4시간 or 자정 중 빠른 것"), 하루 **3회** 상한
- 감성 컬러 팩 콘텐츠 (문구팩, 버블 스킨, 발음 세트)
- 스트릭 프리즈, 추가 카드 (v1.1)

**일회성 IAP — "감성 컬러 팩" (MVP Phase 6 메인):**
- 이름: 색상+감성 조합 (퍼플 드림, 골든 아워, 민트 이브닝, 블루 세러니티 등)
- 콘텐츠: 테마 버블 스킨 1종 + 문구 50개 + 발음 30개
- 가격: ₩1,900 단독 / ₩3,900 2팩 번들
- 현지화: ID IDR 8,000/팩 / PH PHP 29/팩 / BR BRL 3.90/팩 / 영미권 $1.99/팩
- 법적: 아이돌명·팬덤명·로고·이미지 일체 미사용, 사용자 자율 연상에 위임

**Pro 구독 (Phase 7 이후 도입):**
- 광고 완전 제거
- 전체 감성 컬러 팩 접근
- 커스텀 문구 무제한
- TTS 프리미엄 (느린 발음, 반복 재생, 어절별 하이라이트, 버블 내 TTS)
- 자동 프리즈 1개/주, 중복 카드 출현 50% 감소 (v1.1)
- 지역 가격: ID IDR 12,000/월 / PH PHP 39/월 / BR BRL 5.90/월 / 영미권 $1.99~2.99/월

### 3.1.1 전환 퍼널

| 시점 | 행동 |
|---|---|
| Day 0 | 전체 기능 7일 무료 + 최애 아티스트 컬러 선택 개인화 |
| Day 1~3 | 자유 사용, 스트릭 카운터, 비상업적 피드백만 |
| Day 4~7 | 감성 팩 2개+에 보상형 3회/일 적용, 나머지 무료 유지 |
| Day 7+ | 광고 3회 소진 직후 단일 트리거 IAP 팝업 1회 |
| 이벤트 | 컴백·생일 시즌 한정 IAP 팝업 (하루 1회 상한, 중복 금지) |
